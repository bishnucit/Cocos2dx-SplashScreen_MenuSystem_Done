...
void Scene1::DisplayScene(CCObject* pSender)
{
	CCDirector::sharedDirector()->pushScene(Scene1::scene());
}

void Scene1::MainMenu(CCObject* pSender)
{
